...
${O2DPG_ROOT}/MC/bin/o2dpg_sim_workflow.py -eCM 13600 -seed 12345 -col pp -gen pythia8 -j ${NWORKERS} -ns ${NEVENTS} -tf ${NTFS} -e TGeant4 \
    ...
    -trigger "external" -ini /home/stephan/alice/O2DPG/MC/config/MyTasks/ini/trigger_charm_mu_pythia.ini \
	-confKey "GeneratorPythia8.config=/home/stephan/alice/O2DPG/MC/config/MyTasks/pythia8/pythia_charm_mu.cfg;GeneratorPythia8.includePartonEvent=true"
